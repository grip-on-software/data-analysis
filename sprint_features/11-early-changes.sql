SELECT issue.project_id, max_issue.sprint_id, COUNT(*) AS num_early_changes FROM gros.issue,
...
AND issue.rank_change IS NULL AND issue.updated < sprint.start_date
